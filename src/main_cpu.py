...
class LiveTranscriber:
    """Live call transcription system - CPU only."""
    ...
    def start(self):
        ...
        logger.info("Starting reliable live call transcription (CPU-only)...")
        ...
        try:
            ...
            # Initialize transcription engine - FORCE CPU ONLY
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Reliable Live Call Transcription System (CPU-Only)",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # List available audio devices
  python main_reliable_cpu.py --list-devices

  # Start transcription with auto-detected devices
  python main_reliable_cpu.py

  # Specify devices manually
  python main_reliable_cpu.py --mic-device 2 --system-device 1

  # Use tiny model for fastest processing
  python main_reliable_cpu.py --model tiny
        """
    )
