...
from live_call_transcript.audio_capture import ReliableAudioCapture
from live_call_transcript.transcription_engine import ReliableTranscriptionEngine
...
class ReliableLiveTranscriber:
    ...
    def start(self):
        ...
        try:
            ...
            self.transcription_engine = ReliableTranscriptionEngine(
            ...
            self.audio_capture = ReliableAudioCapture(
...
def list_audio_devices():
    ...
    devices = ReliableAudioCapture.list_audio_devices()
    ...
    system_device = ReliableAudioCapture.find_system_audio_device()
...
Examples:
  # List available audio devices
  python main_reliable.py --list-devices

  # Start transcription with auto-detected devices
  python main_reliable.py

  # Specify devices manually
  python main_reliable.py --mic-device 1 --system-device 2

  # Output to specific file
  python main_reliable.py --output my_call

  # Use different language and model
  python main_reliable.py --lang es --model medium

  # Use tiny model for faster processing
  python main_reliable.py --model tiny
        """
    )
